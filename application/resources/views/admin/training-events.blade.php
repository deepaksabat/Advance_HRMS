                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;">{{language_data('Training')}} {{language_data('Subject')}}</th>
                                ...
                                @foreach($training_event as $te)
                                    <tr>
                                        <td data-label="Training Type"><p>{{$te->training_type}}</p></td>
                                        <td data-label="Training Subject"><p>{{$te->training_subject}}</p></td>
                                        <td data-label="Title"><p>{{$te->title}}</p></td>
                                        <td data-label="Training From"><p>{{get_date_format($te->training_from)}}</p></td>
                                        <td data-label="Training To"><p>{{get_date_format($te->training_to)}}</p></td>

                                        <td data-label="Status">
                                            @if($te->status=='upcoming')
                                                <span class="label label-info">{{language_data('Upcoming')}}</span>
                                            @else
                                                <span class="label label-success">{{language_data('Completed')}}</span>
                                            @endif
                                        </td>
